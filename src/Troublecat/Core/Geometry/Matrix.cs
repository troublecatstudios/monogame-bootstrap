...
public struct Matrix : IEquatable<Matrix> {
    ...
    public static implicit operator Microsoft.Xna.Framework.Matrix(Matrix m) => m.ToXnaMatrix();
    public static implicit operator Matrix(Microsoft.Xna.Framework.Matrix m) => new Matrix() {
