...
public struct Rectangle : IEquatable<Rectangle> {
    ...
    /// <summary>
    /// Gets the X position of the left edge of the rectangle.
    /// </summary>
    [JsonIgnore]
    ...
    /// <summary>
    /// Gets the Y position of the top of the rectangle.
    /// </summary>
    [JsonIgnore]
    public float Top { get => Y; set => Y = value; }

    /// <summary>
    /// Gets the Y position of the bottom of the rectangle.
    /// </summary>
    [JsonIgnore]
    public float Bottom { get => Y + Height; set => Height = value - Y; }

    /// <summary>
    /// Gets a <see cref="System.Numerics.Vector2"/> where the X and Y axes represent the width and height of the image respectively.
    /// </summary>
    [JsonIgnore]
    public Vector2 Size {
        get {
    ...
    /// <summary>
    /// Returns <c>true</c> if the Rectangle does not have a position or size set.
    /// </summary>
    ...
    /// <summary>
    /// Creates a new Rectangle from world position points
    /// </summary>
    /// <param name="left"></param>
    /// <param name="right"></param>
    /// <param name="top"></param>
